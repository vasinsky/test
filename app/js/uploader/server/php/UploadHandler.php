 ...
 */
session_start();
define('SUBDIR', isset($_SESSION['fw']['subdir']) ? $_SESSION['fw']['subdir'] : ''); 
...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => DIR.'/'.PATH.'uploads/data/multi/',
            'upload_url' => DIR.'/'.PATH.'uploads/data/multi/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
        ...
        if ($initialize) {
            $this->initialize();
            //echo '<pre>' . print_r($this->initialize(), 1) . '</pre>';
        }
    }
