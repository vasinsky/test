...
tinyMCE.PluginManager.requireLangPack('php', 'en,tr,de,sv,zh_cn,cs,fa,fr_ca,fr,pl,pt_br,nl,da,he,nb,hu,ru,ru_KOI8-R,ru_UTF-8,nn,es,cy,is,zh_tw,zh_tw_utf8,sk,pt_br');
...
tinymce.PluginManager.add("php", TinyMCE_PHPPlugin);
