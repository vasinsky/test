...
******/
  ...
  EditArea.prototype.build(){
    ...
    t.editor_area = document.createElement('div');
    t.editor_area.className = 'editor';
...
//	<div class='editor' id='editor'>
		...
		//<div id='result'>
		//	<div id='container'>
     t.result = document.createElement('div');
     t.container	 = document.createElement('div');

	t.editor_area.appendChild(t.result)
  t.container.appendChild(t.container);			
   ...
   //     <div id='cursor_pos' class='edit_area_cursor'>&nbsp;</div>
	//			<div id='end_bracket' class='edit_area_cursor'>&nbsp;</div>
      ...
      //	<div id='line_number' selec='none'></div>
         t.selection_field	= document.createElement('div');
     t.container.appendChild(t.selection_field);
			//	<div id='content_highlight'></div>
				 t.content_highlight	= document.createElement('div'); //_$("content_highlight");
        //<div id='test_font_size'></div>
				
				 t.test_font_size  = document.createElement('div');
...
/* 				<textarea id='textarea' wrap='off' >
				 ...
				 t.textarea.style.wrap = 'off';
				 t.textarea.onchange= function(){
                    t.execCommand("onchange");
         }
         t.textarea.onfocus = function(){
                 editArea.textareaFocused=true;
         }
         t.textarea.onblur= function(){
